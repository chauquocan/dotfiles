...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "quocan"
    user-mail-address "chauquocan2090@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/quocan/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/quocan/bin" "/profile/bin" "/Users/quocan/.npm-packages/bin" "/Users/quocan/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
